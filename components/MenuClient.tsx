...
export default function MenuClient({
  ...
  // Safety fallback
  const restaurantSettings = settings ?? DEFAULT_SETTINGS;
  ...
  const filtered = useMemo(() => {
    ...
    return [...list].sort((a, b) => {
      if (sort === "price-low") {
        return (
          Number(
            a.half_price ?? a.full_price ?? 0
          ) -
          Number(
            b.half_price ?? b.full_price ?? 0
          )
        );
      }
  ...
  const phoneLink = restaurantSettings.phone.replace(
    /[^\d+]/g,
    ""
  );
    ...
    <main>
      ...
      <header className="sticky top-0 z-30 border-b bg-[#101113]/95 text-white backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <a
            href="#"
            className="text-2xl font-black text-[#e5ad3a]"
          >
            Half & Full
          </a>
          ...
          <a
            href={`tel:${phoneLink}`}
            className="flex items-center gap-2 rounded-full bg-[#e5ad3a] px-4 py-2 text-sm font-bold text-black"
          >
            <Phone size={16} />
            Call
          </a>
      ...
      <section className="relative min-h-[300px] overflow-hidden bg-[#101113] md:min-h-[420px]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[300px] max-w-7xl items-center px-5 py-16 md:min-h-[420px]">
          ...
          <div className="max-w-2xl text-white">
            ...
            {/* <p className="mb-3 inline-block rounded-full bg-[#e5ad3a] px-3 py-1 text-xs font-bold uppercase tracking-wider text-black">
            ...
            {/* <p className="mt-4 text-xl text-white/85 md:text-2xl">
              {banner?.subtitle ||
                "The Taste of Snacks...."}
            </p> */}
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-3 md:flex-row">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Search momos, chowmein, rice..."
              className="w-full rounded-xl border px-10 py-3 outline-none focus:border-[#e5ad3a]"
            />
      ...
      <section className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-5 flex items-end justify-between">
          ...
          <div>
            ...
            <p className="text-sm font-bold uppercase tracking-widest text-[#b17b18]">
              Our Menu
            </p>
            ...
            {filtered.map((item) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs font-bold uppercase tracking-wide text-[#b17b18]">
      ...
      <footer className="bg-[#101113] px-5 py-10 text-center text-white">
        ...
        <h3 className="text-2xl font-black text-[#e5ad3a]">
          Half & Full
        </h3>
        ...
        <p className="mt-4 flex justify-center gap-2 text-sm text-white/70">
          <MapPin size={16} />
          {restaurantSettings.address}
        </p>
        ...
        <a
          href={`tel:${phoneLink}`}
          className="mt-3 inline-flex items-center gap-2 text-sm text-white/70 hover:text-[#e5ad3a]"
        >
          <Phone size={16} />
